...
let careers;
const initCareersData = (data) => { careers = data; }
...
const openCarrerFormDialog = (mode, job) => {
    initSpecs();
    const salaryTypesTabs = document.querySelectorAll('#careers-form-dialog .body #salaries .salary-type-tile');
    for (let tab of salaryTypesTabs) {
        tab.onclick = () => {
            if (currentSalaryType === Number.parseInt(tab.id)) return;

            const activeTab = document.querySelector('#careers-form-dialog .body #salaries .salary-type-tile.active');
    ...
    const jobTypesTabs = document.querySelectorAll('#careers-form-dialog .body #jobs .job-type-tile');
    for (let tab of jobTypesTabs) {
        tab.onclick = () => {
            if (currentJobType === Number.parseInt(tab.id)) return;

            const activeTab = document.querySelector('#careers-form-dialog .body #jobs .job-type-tile.active');
            if (activeTab !== null) activeTab.classList.remove('active');
    ...
    switch (mode) {
        ...
        case 'CREATE':
            ...
            currentArBenefits = [];
            currentArDuties = [];
            document.querySelector('#careers-form-dialog .header h2').innerHTML = 'Create';
            document.querySelector('#careers-form-dialog .options .shadow-button#delete').style.display = 'none';
            document.querySelector('#careers-form-dialog .options .main-button').onclick = createCarrer;

            break;
        case 'EDIT':
            const enTitle = document.querySelector('#careers-form-dialog .body input.single-line-field#en-title');
            enTitle.value = job.title['EN'];
            const arTitle = document.querySelector('#careers-form-dialog .body input.single-line-field#ar-title');
            arTitle.value = job.title['AR'];
            const enSubtitle = document.querySelector('#careers-form-dialog .body input.single-line-field#en-subtitle');
            enSubtitle.value = job.subtitle['EN'];
            const arSubtitle = document.querySelector('#careers-form-dialog .body input.single-line-field#ar-subtitle');
            arSubtitle.value = job.subtitle['AR'];
            const enBio = document.querySelector('#careers-form-dialog .body input.single-line-field#en-bio');
            enBio.value = job.bio['EN'];
            const arBio = document.querySelector('#careers-form-dialog .body input.single-line-field#ar-bio');
            arBio.value = job.bio['AR'];

            const enRequirmentsContainer = document.querySelector('#careers-form-dialog .body #en-requirements #cards');
            ...
            const enDutiesContainer = document.querySelector('#careers-form-dialog .body #en-duties #cards');
            ...
            const enBenefitsContainer = document.querySelector('#careers-form-dialog .body #en-benefits #cards');
            ...
            const arRequirmentsContainer = document.querySelector('#careers-form-dialog .body #ar-requirements #cards');
            ...
            const arDutiesContainer = document.querySelector('#careers-form-dialog .body #ar-duties #cards');
            ...
            const arBenefitsContainer = document.querySelector('#careers-form-dialog .body #ar-benefits #cards');
            ...
            document.querySelector('#careers-form-dialog .header h2').innerHTML = 'Edit';
            document.querySelector('#careers-form-dialog .options .shadow-button#delete').style.display = 'flex';
            document.querySelector('#careers-form-dialog .options .shadow-button#delete').onclick = () => { deleteCarrer(job.id) };
            document.querySelector('#careers-form-dialog .options .main-button').onclick = () => { updateCarrer(job) };
            break;
    }

    document.querySelector('#careers-form-dialog').style.display = 'flex';
    document.querySelector('#careers-form-dialog-overlay').style.display = 'flex';
}


const initSpecs = () => {
    const statusMsg = document.querySelector('#careers-form-dialog .options #status-msg');
    const enRequirmentsField = document.querySelector('#careers-form-dialog .body #en-requirements input.single-line-field');
    const enRequirmentsContainer = document.querySelector('#careers-form-dialog .body #en-requirements #cards');
    const enRequirmentsAction = document.querySelector('#careers-form-dialog .body #en-requirements button.main-button');
    ...
    const enDutiesField = document.querySelector('#careers-form-dialog .body #en-duties input.single-line-field');
    const enDutiesContainer = document.querySelector('#careers-form-dialog .body #en-duties #cards');
    const enDutiesAction = document.querySelector('#careers-form-dialog .body #en-duties button.main-button');
    ...
    const enBenefitsField = document.querySelector('#careers-form-dialog .body #en-benefits input.single-line-field');
    const enBenefitsContainer = document.querySelector('#careers-form-dialog .body #en-benefits #cards');
    const enBenefitsAction = document.querySelector('#careers-form-dialog .body #en-benefits button.main-button');
    ...
    const arRequirmentsField = document.querySelector('#careers-form-dialog .body #ar-requirements input.single-line-field');
    const arRequirmentsContainer = document.querySelector('#careers-form-dialog .body #ar-requirements #cards');
    const arRequirmentsAction = document.querySelector('#careers-form-dialog .body #ar-requirements button.main-button');
    ...
    const arDutiesField = document.querySelector('#careers-form-dialog .body #ar-duties input.single-line-field');
    const arDutiesContainer = document.querySelector('#careers-form-dialog .body #ar-duties #cards');
    const arDutiesAction = document.querySelector('#careers-form-dialog .body #ar-duties button.main-button');
    ...
    const arBenefitsField = document.querySelector('#careers-form-dialog .body #ar-benefits input.single-line-field');
    const arBenefitsContainer = document.querySelector('#careers-form-dialog .body #ar-benefits #cards');
    const arBenefitsAction = document.querySelector('#careers-form-dialog .body #ar-benefits button.main-button');
...
const deleteCarrer = async (jobId) => {
    const statusMsg = document.querySelector('#careers-form-dialog .options #status-msg');
    const submit = document.querySelector('#careers-form-dialog .options .main-button');
    const clear = document.querySelector('#careers-form-dialog .options .shadow-button#clear');
    const close = document.querySelector('#careers-form-dialog .options .shadow-button#cancel');
    const deleteBtn = document.querySelector('#careers-form-dialog .options .shadow-button#delete');
...
const clearCarrerFormDialog = () => {
    ...
    const salaryTypesTabs = document.querySelectorAll('#careers-form-dialog .body #salary-types .salary-type-card');
    for (let salaryTypeTab of salaryTypesTabs) {
        if (salaryTypeTab.classList.contains('active')) salaryTypeTab.classList.remove('active');
    }
    const jobTypesTabs = document.querySelectorAll('#careers-form-dialog .body #job-types .job-type-card');
...
const closeCarrerFormDialog = () => {
    ...
    document.querySelector('#careers-form-dialog').style.display = 'none';
    document.querySelector('#careers-form-dialog-overlay').style.display = 'none';
}
