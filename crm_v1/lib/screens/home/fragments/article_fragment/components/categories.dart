...
class _CategoriesState extends State<ArticlesCategories> {
  @override
          ...
          child: Column(
            ...
            children: [
              RichText(
                ...
                TextSpan(
                  text:
                      "\nRecords for the articles that published in each category (${widget.year})",
                  style: TextStyle(
              ...
              Container(
                ...
                child: Builder(builder: (context) {
                  ...
                  for (var key in widget
                      .data["${widget.year}"]["overall"]["CATEGORIES"]!.keys) {
